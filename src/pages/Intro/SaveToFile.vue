...
<q-page class="flex flex-center text-white bg-main">
  <q-card style="max-width: 700px;" flat>
    <q-card-title class="text-weight-bold">
      <big class="titillium">{{ $t('ChoosePassword.header') }}</big>
    </q-card-title>
    <q-card-main class="text-left">
      ...
      <div class="text-left">
          ...
          <div class="q-py-xs">
            <q-field :error="errors.vertoPasswordEmpty" error-label="Passwords Do Not Match" :count="100" >
          ...
          <div class="q-py-xs">
            <q-field :error="errors.vertoPasswordEmpty" error-label="Verto Password Required" :count="100" >
