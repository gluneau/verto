      ...
      <div class="navbar-end">
        <div class="navbar-item">
          ...
          <div v-if="showDopDownLanguageChildren" class="justify-center">
            ...
            <a class="" @click="updateLanguage('az')">
              <img src="~@/assets/img/lang/az.png" class="br-100 ba b--black-10 h2 w2 mh2" alt="avatar">
            </a>
            <a class="" @click="updateLanguage('pt')">
              <img src="~@/assets/img/lang/pt.png" class="br-100 ba b--black-10 h2 w2 mh2" alt="avatar">
            </a>
...
export default {
  ...
  methods: {
    ...
    showLanguageChildren: function() {
      ...
      this.showDopDownLanguageChildren = true;
    },
    showOptionsChildren: function() {
      this.showDropDownOptions = false;
      this.showDropDownLanguage = false;
