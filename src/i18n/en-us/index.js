...
export default {
    ...
    "CreateVertoPassword": {
        ...
        "createkey": "Create public/private key pairs for a new wallet. Note that <b>ONLY</b> the public key is stored in Verto. You are responsible for the management of your own private key, its storage, and security.",
        "wallets": "Wallets",
        "choose": "Choose to open a wallet by simply clicking on its name.",
        "delete": "Delete Wallet",
        "trash": "Click on the 'Trash' icon",
        "enter": "Enter your password.",
        "note": "<b>NOTE:</b> Verto is unable to recover deleted wallets.",
        "save": "Save"
    },
    "WalletManager": {
    ...
    "SaveYourKeys": {
        ...
        "physical": "<b>Physical Security:</b> Vaults of any kind that provide the protection you are seeking. Think of somewhere you know is safe from theft as well as the elements. some examples are a home or bank safe, or lawyer. you may choose to protect your keys by storing copies in multiple places.",
        "legacy": "<b>Legacy:</b> Things happen. Life ends. You need to plan for the transference of your wallet to someone else. In some cases that may be a will, please consider your options carefully. The choice is yours.",
    ...
    "Main": {
        ...
        "number": "N<sup>o</sup>",
        "copied": "Copied",
        "approvedMessage": "Approved! Get VTX Now!",
        "waitingForApproval": "Waiting Final Approval"
    },
    "TransactionHistory": {
    ...
    "NotApprovedForPurchase": {
        "header": "Awaiting Final Approval",
        "patience": "Please be patient. We are slowly throttling the people who available to Get Vtx.",
        "approved": "Once approved, you will see a message in Verto informing you that you are now able to Get VTX.",
        "back": "Back to Wallet"
    }
  ,
